    ...
    <section className="w-full pt-36 md:pt-38 pb-10 overflow-hidden">
      <div className="flex flex-col gap-6 text-center">
        <div className="flex flex-col gap-6 mx-auto">
          <h1 className="bg-gradient-to-b from-gray-400 via-gray-200 to-gray-600 text-transparent text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl tracking-tighter bg-clip-text pb-2 pr-2">
            Your Career Coach for
            <br />
            Professional Success
          </h1>
          <p className="mx-auto max-w-[600px] text-muted-foreground text-base sm:text-lg md:text-xl px-4">
